...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
             * The do statement executes a statement or a block of statments while a specified
            ...
            /*
             * The while statement executes a statement or a block of statments while a specified 
             * Boolean expression evaluates to true. Because that expression is evaluated before
             * each execution of the loop, which executes one or more times.
             */
